...
Public Class EditOctetStringForm
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(EditOctetStringForm))
        ...
        Me.label13.Text = "Octet String"
        '
        'dataText
        '
        Me.dataText.Location = New System.Drawing.Point(104, 24)
        Me.dataText.Name = "dataText"
        Me.dataText.Size = New System.Drawing.Size(176, 20)
        ...
        Me.ClientSize = New System.Drawing.Size(288, 270)
        ...
        Me.Name = "EditOctetStringForm"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent
        Me.Text = "EditOctetString"
...
#End Region
    ...
    Private Sub EditOctetStringFrom_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub WriteButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles WriteButton.Click
        ...
        Try
            ...
            End If
            Dim ByteArray(Str.Length / 2 - 1) As Byte
            Dim count As Integer
            For count = 0 To Str.Length / 2 - 1
                varStr = Str.Substring(startIndex, 2)
                startIndex += 2
                ByteArray(count) = Byte.Parse(varStr)
            Next
