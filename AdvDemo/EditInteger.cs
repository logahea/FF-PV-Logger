 ...
 * EditInteger.cs
 * implementation of writing paramter whose type is integer
 */
using System;
...
{
	/// <summary>
	/// Summary description for EditInteger.
	/// </summary>
	public class EditIntegerForm : System.Windows.Forms.Form
	{
		...
		public EditIntegerForm(Parameter param, Element element)
		{
			InitializeComponent();
			curElement = element;
			curParameter = param;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(EditIntegerForm));
			...
			this.Name = "EditIntegerForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "EditInteger";
			this.Load += new System.EventHandler(this.EditIntegerForm_Load);
		...
		private void WriteButton_Click(object sender, System.EventArgs e)
		{
			...
			string dataString = dataText.Text;
			try
			{
				switch(curElement.Type)
				{
					...
					case ElementType.FF_INTEGER16:
						curElement.Value = Int16.Parse(dataString);
						break;
					case ElementType.FF_INTEGER32:
					case ElementType.FF_UNSIGNED16:
						curElement.Value = Int32.Parse(dataString);
						break;
					case ElementType.FF_UNSIGNED8:
						curElement.Value = Byte.Parse(dataString);
						break;
					case ElementType.FF_UNSIGNED32:
						curElement.Value = Int64.Parse(dataString);
						break;
				}
				curParameter.Write();
		...
		private void EditIntegerForm_Load(object sender, System.EventArgs e)
		{
