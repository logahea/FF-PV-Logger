 ...
 * EditOctetString.cs
 * implementation of writing paramter whose type is FF_OCTET_STRING
 */
using System;
...
{
	/// <summary>
	/// Summary description for EditOctetString.
	/// </summary>
	public class EditOctetStringForm : System.Windows.Forms.Form
	{
		...
		public EditOctetStringForm(Parameter param, Element element)
		{
			InitializeComponent();
			curElement = element;
			curParameter = param;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(EditOctetStringForm));
			...
			// ExitButton
			// 
			this.ExitButton.Location = new System.Drawing.Point(115, 150);
			...
			// WriteButton
			// 
			this.WriteButton.Location = new System.Drawing.Point(35, 150);
			...
			this.Name = "EditOctetStringForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "EditOctetString";
			this.Load += new System.EventHandler(this.EditOctetStringForm_Load);
		...
		private void EditOctetStringForm_Load(object sender, System.EventArgs e)
		{
		...
		private void WriteButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					varStr = str.Substring(startIndex,2);
					startIndex += 2;
					byteArray[i] = byte.Parse(varStr);
				}
				curElement.Value = byteArray;
				curParameter.Write();
