 ...
 * EditFloat.cs
 * implementation of writing paramter whose type is FF_FLOAT
 */
using System;
...
{
	/// <summary>
	/// Summary description for EditFloat.
	/// </summary>
	public class EditFloatForm : System.Windows.Forms.Form
	{
		...
		public EditFloatForm(Parameter param, Element element)
		{
			InitializeComponent();
			curElement = element;
			curParameter = param;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(EditFloatForm));
			...
			this.ExitButton.Location = new System.Drawing.Point(120, 153);
			...
			this.WriteButton.Location = new System.Drawing.Point(32, 153);
			...
			// dataText
			// 
			this.dataText.Location = new System.Drawing.Point(53, 8);
			this.dataText.Name = "dataText";
			this.dataText.Size = new System.Drawing.Size(147, 20);
			...
			this.Name = "EditFloatForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "EditFloat";
			this.Load += new System.EventHandler(this.EditFloat_Load);
		...
		private void EditFloat_Load(object sender, System.EventArgs e)
		{
		...
		private void WriteButton_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				curElement.Value = Single.Parse(dataText.Text);
				curParameter.Write();
