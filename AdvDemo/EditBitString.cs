...
{
	/// <summary>
	/// Summary description for EditBitString.
	/// </summary>
	public class EditBitStringForm : System.Windows.Forms.Form
	{
		...
		public EditBitStringForm(Parameter param, Element element)
		{
			InitializeComponent();
			curElement = element;
			curParameter = param;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(EditBitStringForm));
			...
			// ExitButton
			// 
			this.ExitButton.Location = new System.Drawing.Point(112, 184);
			...
			// WriteButton
			// 
			this.WriteButton.Location = new System.Drawing.Point(32, 184);
			...
			this.label1.Text = "Note:Only 0 or 1 is acceptable";
			// 
			// EditBitStringForm
			// 
			...
			this.Name = "EditBitStringForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.Text = "EditBitString";
			this.Load += new System.EventHandler(this.EditBitStringForm_Load);
		...
		private void EditBitStringForm_Load(object sender, System.EventArgs e)
		{
		...
		{
			MessageStatus.Text="Write Object ...";
			try
			{
